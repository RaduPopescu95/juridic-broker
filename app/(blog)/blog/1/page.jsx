              ...
              <div className="col-lg-8">
                <div className="blog-meta-wrapper pe-xxl-5">
                  <article className="blog-details-content">
                    ...
                    <h2 className="text-justify">Oferta specială: Reduceri exclusive la polițe</h2>
                    ...
                    <h2 className="text-justify">Economisește inteligent cu reducerile noastre exclusive</h2>
                    <p className="text-justify">
                    ...
                    <h2 className="text-justify">Asigurare auto – Mai multă protecție, costuri reduse</h2>
                    <p className="text-justify">
                    ...
                    <h2 className="text-justify">Protecție pentru locuința ta la tarife speciale</h2>
                    <p className="text-justify">
                    ...
                    <h2 className="text-justify">Asigurări de sănătate – Prețuri speciale, servicii complete</h2>
                    <p className="text-justify">
                    ...
                    <h2 className="text-justify">Asigurarea de viață – Mai accesibilă ca oricând</h2>
                    <p className="text-justify">
                    ...
                    <h2 className="text-justify">Fără limită de timp, doar oportunități constante</h2>
                    <p className="text-justify">
                    ...
                    <h2 className="text-justify">Accesează oferta și consultă un specialist</h2>
                    <p className="text-justify">
